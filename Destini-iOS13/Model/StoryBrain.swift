...
struct StoryBrain {
    ...
    mutating func updateCurrentDestination(for choice: String) {
        if choice == storyLine[currentDest].choice1 {
            currentDest = storyLine[currentDest].choice1Destination
        } else {
            currentDest = storyLine[currentDest].choice2Destination
        }
    }
    
    func getStory() -> Story {
        return storyLine[currentDest]
    }
}
